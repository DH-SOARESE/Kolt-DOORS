--[[
📦 Model ESP Library Plus v1.2 - Estilo Hub Refinado
👤 Autor: DH SOARES (Melhorias por Gemini)

🎯 Objetivo:
Sistema ESP otimizado e estilizado para jogos como Roblox Doors.

🧩 Funcionalidades:
✅ Nome, Distância e Tracer com Círculo
✅ Highlight com Fill/Outline
✅ Origem configurável (Top, Center, Bottom etc.)
✅ Código limpo, modular e pronto para expansão
]]
...
RunService.RenderStepped:Connect(function()
	...
	for i = #ModelESP.Objects, 1, -1 do
		...
		-- Atualiza círculo decorativo no ponto de origem
